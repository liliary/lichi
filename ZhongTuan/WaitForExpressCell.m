//
//  WaitForExpressCell.m
//  ZhongTuan
//
//  Created by anddward on 15/4/18.
//  Copyright (c) 2015年 TeamBuy. All rights reserved.
//

#import "WaitForExpressCell.h"
@interface WaitForExpressCell(){
    UILabel *_dolla;            //价格符号
    UILabel*_shuliang ;            //数量
}
@end

@implementation WaitForExpressCell
...
_state=[[UILabel alloc]init];
    ...
    _qrsh= [UIButton new];
   [_qrsh setTitle:@"确认收货" forState: UIControlStateNormal];
